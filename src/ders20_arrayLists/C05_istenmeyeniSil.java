...
public class C05_istenmeyeniSil {
    public static void main(String[] args) {
        ...
        List<String> liste = C04_KullaniciyaListeOlusturtmak.kullaniciyaListOlusturma();
    ...
    public static List<String> istenmeyenHarfIcerenleriSil(List<String> liste, String istenmeyenHarf) {
        ...
        // list'in uzulugu degisecegi icin sorun yasariz
        // farkli bir list olusturup, silinmeyecekelri yeni listeye kaydedelim
